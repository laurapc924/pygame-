...
class GameOverState(BaseState):
    ...
    def __init__(self, game, score_manager=None):
        """Inicializa fontes, cenário noturno e verifica novo recorde."""
        super().__init__(game)
        ...
        self.background = criar_background_perdeu(WIDTH, HEIGHT)
    ...
    def update(self, dt):
        """Alterna o painel de novo recorde piscando a cada 0.5s."""
    ...
    def draw(self, screen):
        """Desenha o cenário noturno como fundo e o painel de pontuação por cima."""
