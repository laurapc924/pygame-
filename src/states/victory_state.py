...
class VictoryState(BaseState):
    ...
    def __init__(self, game, score_manager=None):
        """Inicializa fontes, cenário, confete e verifica novo recorde."""
        super().__init__(game)
    ...
    def update(self, dt):
        """Avança o tempo (animações) e faz o confete cair, reciclando no topo."""
        self.tempo += dt
    ...
    def draw(self, screen):
        """Desenha cenário, confete, título, pontuação, recorde e botões."""
